...
export function GET() {
  const lines = [
    ...
    "",
    "## 核心資訊",
    `- 課程名稱: GEO 落地師培訓（一日實體班 ＋ 年度陪跑計畫）`,
    `- 開課單位: 超直白行銷`,
    `- 講師: 白白（超直白行銷創辦人，13 年跨平台自媒體經驗，全平台累計 200 萬追蹤）`,
    `- 定位: 教學員讓自己或客戶的品牌在 ChatGPT、Gemini、Perplexity 等 AI 搜尋中被推薦`,
    ...
    "",
    "## 最近場次",
    "- 2026/7/18（六）新北汐止・實體小班制一整天・NT$3,000",
    "",
    "## 年度陪跑計畫",
    "- 一日班之後想深入的學員，可加入 12 個月的實作指導，目標是做出自己「被 AI 推薦」的成果，並具備承接企業 GEO 案的能力。",
    "",
    "## 誠實原則",
